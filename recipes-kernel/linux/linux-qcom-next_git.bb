...
SRC_URI += " \
    ...
    file://patches/0004-arm64-dts-qcom-Add-LeMans-Draco-EVK-board-device-tre.patch \
    file://patches/0005-arm64-dts-qcom-lemans-draco-evk-add-board-support.patch \
"

# Out-of-tree driver fixes.
SRC_URI += " \
    file://patches/0006-gpio-pca953x-add-dev_err_probe-logging.patch \
"
